...
description: >
  ...
  user invokes $victor-codex-skills:simplify or explicitly says "run simplify". Do not trigger
  automatically after routine code changes, during review, while writing comments, or when the
  user is discussing or configuring the skill.
---
