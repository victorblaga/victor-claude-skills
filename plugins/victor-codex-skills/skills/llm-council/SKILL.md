...
- **Parallel subagents**: Launch all 5 advisors simultaneously in a single turn. Run peer-review subagents in parallel as well. Spawn fewer subagents by default—explicitly fan out.
