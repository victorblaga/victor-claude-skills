...
2. **Local knowledge artifacts** - project-owned instruction or knowledge files that guide future work, for example `AGENTS.md`, `CLAUDE.md`, repo-local skill references, or tool-specific project memory directories if the team keeps them.
...
```
.scratch/docs/plans/<feature-name>/doc-reconciliation.md
```
...
- The proposal (`.scratch/docs/plans/<feature-name>/proposal.md`)
- The final validation (`.scratch/docs/plans/<feature-name>/final-validation.md`)
...
- `AGENTS.md`, `CLAUDE.md`, and similar instruction files
