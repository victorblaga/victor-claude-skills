...
Launch a **subagent with fresh context** (tier: DEEP — see Capability Tiers in SKILL.md; STANDARD for Small workflows) to review the proposal. The subagent receives:
...
1. Launch a subagent (tier: STANDARD — see Capability Tiers in SKILL.md; or do it yourself if the changes are straightforward) to update `proposal.md` incorporating all resolved findings
